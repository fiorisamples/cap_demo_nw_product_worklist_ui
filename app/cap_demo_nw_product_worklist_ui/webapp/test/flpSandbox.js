		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#capdemonwproductworklistui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capdemonwproductworklistui-display": {
								"semanticObject": "capdemonwproductworklistui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=capdemonwproductworklistui",
									"url": sap.ui.require.toUrl("capdemonwproductworklistui")
								}
							}
						}
					}
